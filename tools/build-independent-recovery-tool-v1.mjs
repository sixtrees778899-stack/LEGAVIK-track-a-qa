...
const identity='legavik-independent-recovery-tool-v1-evidence-20260914-1';
...
const executableSha256=createHash('sha256').update(javascript).digest('hex');
...
const manifest={tool_name:'LEGAVIK Independent Recovery Tool',tool_version:'1.1.0',build_identity:identity,executable_sha256:executableSha256,supported:{recovery_kit_version:[1],archive_version:[1],snapshot_version:[1],knowledge_map_schema_versions:[1,2]},dependencies:{account_login:false,supabase:false,supabase_auth:false,backend_api:false,server_secret:false,browser_web_crypto:true,arweave_gateway:true},customer_materials_embedded:false};
