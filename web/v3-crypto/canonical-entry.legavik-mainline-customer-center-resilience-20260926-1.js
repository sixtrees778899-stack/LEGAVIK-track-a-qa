(()=>{
  ...
  gate.boot({
    ...
    scripts:[
      {src:'../account/public-config.legavik-mainline-customer-center-resilience-20260926-1.js'},
      {src:'../account/account-nav-bridge.legavik-mainline-customer-center-resilience-20260926-1.bundle.js'},
      {src:'./product-v1.legavik-mainline-customer-center-resilience-20260926-1.bundle.js',type:'module',id:'legavik-product-app'}
    ]
  });
})();
