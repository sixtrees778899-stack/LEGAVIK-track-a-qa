(()=>{
  ...
  gate.boot({
    ...
    scripts:[
      {src:'../account/public-config.legavik-mainline-gateway-recovery-20260926-1.js'},
      {src:'../account/account-nav-bridge.legavik-mainline-gateway-recovery-20260926-1.bundle.js'},
      {src:'./product-v1.legavik-mainline-gateway-recovery-20260926-1.bundle.js',type:'module',id:'legavik-product-app'}
    ]
  });
})();
