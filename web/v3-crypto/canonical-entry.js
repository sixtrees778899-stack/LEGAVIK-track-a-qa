(()=>{
  ...
  gate.boot({
    ...
    scripts:[
      {src:'../account/public-config.legavik-mainline-normal-flow-candidate-20260925-1.js'},
      {src:'../account/account-nav-bridge.legavik-mainline-normal-flow-candidate-20260925-1.bundle.js'},
      {src:'./product-v1.legavik-mainline-normal-flow-candidate-20260925-1.bundle.js',type:'module',id:'legavik-product-app'}
    ]
  });
})();
